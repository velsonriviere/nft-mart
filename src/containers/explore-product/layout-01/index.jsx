...
const ExploreProductArea = ({ className, space, data }) => {
    ...
    const priceHandler = (value) => {
        dispatch({ type: "SET_INPUTS", payload: { itemPrice: value } });
    };
*/
    }
    {
    ...
    const filterMethods = (item, filterKey, value) => {
        ...
        if (filterKey === "itemPrice") {
            return (
                item[itemKey] <= value[0] / 100 ||
                item[itemKey] >= value[1] / 100
            );
        }
                                ...
                                (
                                    ...
                                    >
                                        <Product
                                            ...
                                            royalty={prod.royalty}
                                            // likeCount={prod.likeCount}
                                            //auction_date={prod.auction_date}
                                            image={prod.url} //prod.images?.[0]
